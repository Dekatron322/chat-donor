...
import CustomerOrders from "components/Tables/CustomerOrders"
      ...
      <div className="flex min-h-screen w-full">
        <div className="flex  w-full flex-col">
          ...
          <div className="flex flex-col">
            <div className="flex items-center justify-between border-b px-16 py-4">
              ...
              <div className="flex gap-4">
                ...
                <button className="button__primary" type="button">
                  <FaRegCheckCircle />
                  <p className="text-white">Contact Customer </p>
                </button>
            ...
            <div className="flex items-center justify-between border-y px-16 py-4">
              <div className="flex items-center gap-2">
